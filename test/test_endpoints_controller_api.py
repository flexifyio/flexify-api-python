...
class TestEndpointsControllerApi(unittest.TestCase):
    ...
    def test_attach_storages_to_endpoint(self):
        """Test case for attach_storages_to_endpoint
    ...
    def test_set_storage_put_objects(self):
        """Test case for set_storage_put_objects
