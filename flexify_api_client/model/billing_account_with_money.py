...
class BillingAccountWithMoney(object):
    ...
    def __init__(self, admin_state=None, aggregate_state=None, balance=None, billing_state=None, created_date=None, credit_exceeded=None, id=None, max_credit=None, name=None, total_cost=None, total_paid=None):  # noqa: E501
