# swagger_client.StoragesControllerApi
...
api_instance = swagger_client.StoragesControllerApi(swagger_client.ApiClient(configuration))
request = swagger_client.AddStorageAccountRequest() # AddStorageAccountRequest | request
...
request = swagger_client.AddStoragesRequest() # AddStoragesRequest | request
...
# create an instance of the API class
api_instance = swagger_client.StoragesControllerApi(swagger_client.ApiClient(configuration))
request = swagger_client.IdsList() # IdsList | request
