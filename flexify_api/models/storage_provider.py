...
class StorageProvider(object):
    ...
    def __init__(self, default_region=None, disabled_as_destination=None, dot_encode=None, endpoint=None, id=None, multi_regional=None, name=None, port_http=None, port_https=None, product_name=None, protocol=None, regions=None, supports_http=None, supports_https=None):  # noqa: E501
    ...
    def dot_encode(self):
        ...
        Indicates that the privder does not support dots in bucket names and how dots should be encoded  # noqa: E501
    ...
    def protocol(self, protocol):
        ...
        :type: str
        """
        allowed_values = ["S3", "AZURE", "B2", "GOOGLE", "OPENSTACK", "RACKSPACE"]  # noqa: E501
