...
class StorageProvider(object):
    ...
    swagger_types = {
        ...
        'product_name': 'str',
        'protocol': 'str',
        'supported_o_auth_providers': 'list[str]',
    ...
    attribute_map = {
        ...
        'protocol': 'protocol',
        'supported_o_auth_providers': 'supportedOAuthProviders',
    ...
    def __init__(self, allow_overwrite_endpoint=None, bucket_dot_encode=None, can_create_buckets_with_uppercase=None, code=None, default_region=None, disabled_as_destination=None, endpoint=None, endpoint_pattern=None, id=None, max_upload_size=None, multi_regional=None, name=None, port_http=None, port_https=None, private_endpoint=None, private_endpoint_pattern=None, product_name=None, protocol=None, supported_o_auth_providers=None, supports_credential=None, supports_http=None, supports_https=None, supports_multipart_upload=None, _configuration=None):  # noqa: E501
        ...
        self._protocol = None
        self._supported_o_auth_providers = None
        ...
        if supported_o_auth_providers is not None:
            self.supported_o_auth_providers = supported_o_auth_providers
    ...
    @property
    def supported_o_auth_providers(self):
        """Gets the supported_o_auth_providers of this StorageProvider.  # noqa: E501

        The list of OAuth providers that can be used with this storage provider (instead of storage keys)  # noqa: E501

        :return: The supported_o_auth_providers of this StorageProvider.  # noqa: E501
        :rtype: list[str]
        """
        return self._supported_o_auth_providers

    @supported_o_auth_providers.setter
    def supported_o_auth_providers(self, supported_o_auth_providers):
        """Sets the supported_o_auth_providers of this StorageProvider.

        The list of OAuth providers that can be used with this storage provider (instead of storage keys)  # noqa: E501

        :param supported_o_auth_providers: The supported_o_auth_providers of this StorageProvider.  # noqa: E501
        :type: list[str]
        """
        allowed_values = ["DROPBOX", "DROPBOX_TEAM", "MICROSOFT"]  # noqa: E501
        if (self._configuration.client_side_validation and
                not set(supported_o_auth_providers).issubset(set(allowed_values))):  # noqa: E501
            raise ValueError(
                "Invalid values for `supported_o_auth_providers` [{0}], must be a subset of [{1}]"  # noqa: E501
                .format(", ".join(map(str, set(supported_o_auth_providers) - set(allowed_values))),  # noqa: E501
                        ", ".join(map(str, allowed_values)))
            )

        self._supported_o_auth_providers = supported_o_auth_providers
