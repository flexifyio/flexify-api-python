...
class BillingAccount(object):
    ...
    def __init__(self, admin_state=None, aggregate_state=None, billing_state=None, created_date=None, distributor=None, id=None, max_credit=None, name=None):  # noqa: E501
