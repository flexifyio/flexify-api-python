...
class StorageAccountSettings(object):
    ...
    def __init__(self, anonymous=None, credential=None, identity=None, name=None, refresh_interval_sec=None, refresh_storages_stat=None, use_ssl=None):  # noqa: E501
    ...
    def refresh_storages_stat(self):
        ...
        Indicates if statistics for each bucket/container should be calculated on refresh  # noqa: E501
