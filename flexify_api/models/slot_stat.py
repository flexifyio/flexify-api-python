...
class SlotStat(object):
    ...
    def __init__(self, active_engines=None, active_streams=None, bytes_failed=None, bytes_not_matching_pattern=None, bytes_processed=None, bytes_skipped=None, bytes_uploaded=None, finished=None, objects_failed=None, objects_not_matching_pattern=None, objects_processed=None, objects_skipped=None, objects_uploaded=None, processing_objects_per_second=None, retried=None, started=None, state=None, uploading_bytes_per_second=None, uploading_objects_per_second=None):  # noqa: E501
