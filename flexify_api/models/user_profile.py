...
class UserProfile(object):
    ...
    def __init__(self, city=None, company=None, country=None, display_name=None, email=None, phone=None, street_first_line=None, street_second_line=None, zip=None):  # noqa: E501
