...
class User(object):
    ...
    def __init__(self, account=None, delete_requested=None, external_id=None, id=None, org=None, profile=None, registered=None, roles=None, state=None, username=None):  # noqa: E501
