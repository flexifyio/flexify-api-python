...
class UsersControllerApi(object):
    ...
    def get_current_user_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['context_path', 'locale_iso3_country', 'locale_iso3_language', 'locale_country', 'locale_display_country', 'locale_display_language', 'locale_display_name', 'locale_display_script', 'locale_display_variant', 'locale_language', 'locale_script', 'locale_unicode_locale_attributes', 'locale_unicode_locale_keys', 'locale_variant', 'remote_user', 'secure', 'user_principal_name']  # noqa: E501
    ...
    def request_reset_password(self, reqeust, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_reset_password(reqeust, async_req=True)
        >>> result = thread.get()
    ...
    def request_reset_password_with_http_info(self, reqeust, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_reset_password_with_http_info(reqeust, async_req=True)
        >>> result = thread.get()
