...
class StorageAccountsControllerApi(object):
    ...
    def add_storage_accounts_with_azure_integration(self, request, **kwargs):  # noqa: E501
        """Add multiple storage accounts with Azure integration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_storage_accounts_with_azure_integration(request, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param AddStorageAccountsWithAzureLinkRequest request: request (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.add_storage_accounts_with_azure_integration_with_http_info(request, **kwargs)  # noqa: E501
        else:
            (data) = self.add_storage_accounts_with_azure_integration_with_http_info(request, **kwargs)  # noqa: E501
            return data

    def add_storage_accounts_with_azure_integration_with_http_info(self, request, **kwargs):  # noqa: E501
        """Add multiple storage accounts with Azure integration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_storage_accounts_with_azure_integration_with_http_info(request, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method add_storage_accounts_with_azure_integration" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'request' is set
        if self.api_client.client_side_validation and ('request' not in params or
                                                       params['request'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `request` when calling `add_storage_accounts_with_azure_integration`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/backend/rest/storage-accounts/azure-integration', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='list[IdResponse]',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def reauth_storage_account(self, auth_params, storage_account_id, **kwargs):  # noqa: E501
        """Reauthenticate storage account  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reauth_storage_account(auth_params, storage_account_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.reauth_storage_account_with_http_info(auth_params, storage_account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.reauth_storage_account_with_http_info(auth_params, storage_account_id, **kwargs)  # noqa: E501
            return data

    def reauth_storage_account_with_http_info(self, auth_params, storage_account_id, **kwargs):  # noqa: E501
        """Reauthenticate storage account  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.reauth_storage_account_with_http_info(auth_params, storage_account_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['auth_params', 'storage_account_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method reauth_storage_account" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('auth_params' not in params or
            ...
            raise ValueError("Missing the required parameter `auth_params` when calling `reauth_storage_account`")  # noqa: E501
        # verify the required parameter 'storage_account_id' is set
        if self.api_client.client_side_validation and ('storage_account_id' not in params or
                                                       params['storage_account_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `storage_account_id` when calling `reauth_storage_account`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/backend/rest/storage-accounts/{storage-account-id}/reauth', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
