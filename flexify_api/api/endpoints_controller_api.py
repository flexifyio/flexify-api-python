...
class EndpointsControllerApi(object):
    ...
    def create_endpoint(self, settings, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param EndpointSettingsReq settings: settings (required)
        :return: IdResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_endpoint_secret_key(self, endpoint_id, **kwargs):  # noqa: E501
        """Get endpoint secret key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_endpoint_secret_key(endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_endpoint_secret_key_with_http_info(endpoint_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_endpoint_secret_key_with_http_info(endpoint_id, **kwargs)  # noqa: E501
            return data

    def get_endpoint_secret_key_with_http_info(self, endpoint_id, **kwargs):  # noqa: E501
        """Get endpoint secret key  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_endpoint_secret_key_with_http_info(endpoint_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_endpoint_secret_key" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'endpoint_id' is set
        if self.api_client.client_side_validation and ('endpoint_id' not in params or
                                                       params['endpoint_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `endpoint_id` when calling `get_endpoint_secret_key`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/backend/rest/endpoints/{endpoint-id}/settings/secret-key', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='EndpointSecretResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
