...
class PartnerOrganizationsControllerApi(object):
    ...
    def get_org_limits(self, org_id, **kwargs):  # noqa: E501
        """getOrgLimits  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_org_limits(org_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int org_id: orgId (required)
        :return: UserConfig
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_org_limits_with_http_info(org_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_org_limits_with_http_info(org_id, **kwargs)  # noqa: E501
            return data

    def get_org_limits_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """getOrgLimits  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_org_limits_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('org_id' not in params or
            ...
            raise ValueError("Missing the required parameter `org_id` when calling `get_org_limits`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/backend/rest/partner/organizations/{orgId}/limits', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='UserConfig',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
