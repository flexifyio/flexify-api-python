...
class PartnerUsersControllerApi(object):
    ...
    def get_all_users_pageable(self, offset, page, **kwargs):  # noqa: E501
        """Get users with search, sorting and pagination  # noqa: E501

        Gets a list of users managed by this distributor  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_users_pageable(offset, page, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_users_pageable_with_http_info(offset, page, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_users_pageable_with_http_info(offset, page, **kwargs)  # noqa: E501
            return data

    def get_all_users_pageable_with_http_info(self, offset, page, **kwargs):  # noqa: E501
        """Get users with search, sorting and pagination  # noqa: E501

        Gets a list of users managed by this distributor  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_users_pageable_with_http_info(offset, page, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_users_pageable" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('offset' not in params or
            ...
            raise ValueError("Missing the required parameter `offset` when calling `get_all_users_pageable`")  # noqa: E501
        # verify the required parameter 'page' is set
        if self.api_client.client_side_validation and ('page' not in params or
                                                       params['page'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `page` when calling `get_all_users_pageable`")  # noqa: E501
        ...
        if 'search_string' in params:
            query_params.append(('search-string', params['search_string']))  # noqa: E501
        if 'size' in params:
        ...
        return self.api_client.call_api(
            '/backend/rest/distributor/users/search', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PageUserStat',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_users_pageable1(self, offset, page, **kwargs):  # noqa: E501
        """Get users with search, sorting and pagination  # noqa: E501

        Gets a list of users managed by this distributor  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_users_pageable1(offset, page, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_all_users_pageable1_with_http_info(offset, page, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_users_pageable1_with_http_info(offset, page, **kwargs)  # noqa: E501
            return data

    def get_all_users_pageable1_with_http_info(self, offset, page, **kwargs):  # noqa: E501
        """Get users with search, sorting and pagination  # noqa: E501

        Gets a list of users managed by this distributor  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_users_pageable1_with_http_info(offset, page, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_users_pageable1" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'offset' is set
        if self.api_client.client_side_validation and ('offset' not in params or
                                                       params['offset'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `offset` when calling `get_all_users_pageable1`")  # noqa: E501
        # verify the required parameter 'page' is set
        if self.api_client.client_side_validation and ('page' not in params or
                                                       params['page'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `page` when calling `get_all_users_pageable1`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/backend/rest/partner/users/search', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
