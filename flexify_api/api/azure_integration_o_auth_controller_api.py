...
class AzureIntegrationOAuthControllerApi(object):
    ...
    def get_config_for_storage_list(self, **kwargs):  # noqa: E501
        """Get OAuth configuration to authorize Azure integration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_config_for_storage_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_config_for_storage_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_config_for_storage_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_config_for_storage_list_with_http_info(self, **kwargs):  # noqa: E501
        """Get OAuth configuration to authorize Azure integration  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_config_for_storage_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_config_for_storage_list" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def get_device_code_for_storage_list(self, **kwargs):  # noqa: E501
        """Request device code to authorize Azure integration with device code flow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_code_for_storage_list(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_device_code_for_storage_list_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_device_code_for_storage_list_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_device_code_for_storage_list_with_http_info(self, **kwargs):  # noqa: E501
        """Request device code to authorize Azure integration with device code flow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_device_code_for_storage_list_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_device_code_for_storage_list" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/backend/rest/azure-integration/oauth/device-code', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
