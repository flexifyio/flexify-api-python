...
class LogControllerApi(object):
    ...
    def get_log_for_current_user(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_log_for_current_user(async=True)
        >>> result = thread.get()
    ...
    def get_log_for_current_user_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_log_for_current_user_with_http_info(async=True)
        >>> result = thread.get()
        ...
        all_params = ['storage_id', 'migration_id', 'endpoint_id', 'sort', 'page', 'size', 'sort_direction']  # noqa: E501
