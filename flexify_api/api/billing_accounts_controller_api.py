...
class BillingAccountsControllerApi(object):
    ...
    def get_costs_for_current_user_billing_account(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_costs_for_current_user_billing_account(async=True)
        >>> result = thread.get()
    ...
    def get_costs_for_current_user_billing_account_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_costs_for_current_user_billing_account_with_http_info(async=True)
        >>> result = thread.get()
